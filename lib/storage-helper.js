...
export async function saveHandle(configId, handle) {
	// Don't save virtual handles to IndexedDB as they are not serializable/persistent
	if (handle && handle.constructor && handle.constructor.name === 'VirtualDirectoryHandle') {
